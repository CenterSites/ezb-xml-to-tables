...
/*
   $ServerName = "{imap.mailprotect.be/imap:143}INBOX"; // For a IMAP connection    (PORT 143)
   //$ServerName = "{pop3.mailprotect.be/pop3:110}INBOX"; // For a POP3 connection    (PORT 110)
   
   $UserName = "upload@huvema.com";
   $PassWord = "MailAtt123";
...
class Email_reader {
	...
	private $server = 'imap.mailprotect.be';
	private $user   = 'upload@huvema.com';
	private $pass   = 'MailAtt123';
